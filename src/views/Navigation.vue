<template>
  <div
    class="text-white subpixel-antialiased bg-primary-content skeleton border border-base-300 opacity-90 text-4xl rounded-lg md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl"
    id="navigation-panel"
