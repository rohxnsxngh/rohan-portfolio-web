<template>
  ...
  >
    ...
    <div class="px-2">
      <div
        class="carousel carousel-center max-w-xl bg-primary-content sm:h-1/2 h-10/12 rounded-box focus-within:p-2"
      >
        <div class="carousel-item">
          <img
            id="item1"
            src="/Images/ToyotaConceptCar.jpeg"
        ...
        <div class="carousel-item">
          <img
            id="item3"
            src="/Images/LexusConceptCar.jpg"
            class="rounded-box object-cover"
          />
        </div>
      </div>
